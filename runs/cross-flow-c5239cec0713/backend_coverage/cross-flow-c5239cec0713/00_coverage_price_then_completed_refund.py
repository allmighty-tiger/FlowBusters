CONFIG = {'origin': 'http://localhost:3000', 'setup': '/api/demo/reset', 'state_read': '/api/order', 'actions': [{'endpoint': '/api/order/price-adjustment', 'body': {}}, {'endpoint': '/api/order/refund/request', 'body': {}}, {'endpoint': '/api/order/refund/complete', 'body': {}}], 'invariant': {'operator': 'sum_lte', 'terms': [['order', 'totalReturned']], 'limit': ['order', 'originalAmount']}, 'name': 'price then completed refund'}
