CONFIG = {'origin': 'http://localhost:3000', 'setup': '/api/demo/reset', 'state_read': '/api/order', 'actions': [{'endpoint': '/api/order/cancel', 'body': {'reimbursementAmount': 200}}], 'invariant': {'operator': 'sum_lte', 'terms': [['order', 'totalReturned']], 'limit': ['order', 'originalAmount']}, 'name': 'cancel amount bound'}
